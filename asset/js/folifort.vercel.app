...
<div class="container mt-5 position-relative">
   <br> <img src="images/top-ribbon.png" class="img-fluid position-absolute start-50 translate-middle px-3" style="">
    <div class="text-center px-4 py-5 shadow rounded-15 bg-white"> <a href="https://topratedproducts.org/folifortga234" target="_blank" rel="nofollow"><br><br>
      <span class="mt-4"><img src="images/actnow.png" class="img-fluid mx-auto d-block"></span><br><img src="images/11.png" class="img-fluid mx-auto d-block"></a>
				...
				<div class="mt-5"><a href="https://topratedproducts.org/folifortga234" rel="nofollow" role="button" class="btn btn-order pulse font-fjalla"><strong>Check Availability Now <em class="ms-2 ms-sm-3 bi bi-arrow-right-circle-fill"></em></strong></a><br><img src="images/arrows.png" width="160" height="auto" alt=""/><span class="mt-4"></span><strong><br><br>
				</strong></div>
</div>
	<div class="mt-5"><img src="images/secureprivacy.png" class="img-fluid mx-auto d-block" ></div>
	<div class="bg-highlight mt-4"> </div>
<span class="mt-4"></a></a></div>
<span class="mt-4"></span></a>    </main>
<center></center>
...
<p class="text-center"><a rel="nofollow" href="privacy.html" target="_blank">Privacy Policy</a> - <a href="terms.html">Terms &amp; Condtions</a> - <a href="references.html">References</a> - <a href="disclaimer.html">Disclaimer</a> - <a rel="nofollow" href="privacy.html" target="_blank">Contact Us</a></p>
		  <p class="text-center"> *The information contained within this site is not intended as a substitute for professional medical advice. If you have, expect to have, or suspect you may have any medical condition, you are urged to consult with a health care provider. These statements have not been evaluated by the Food and Drug Administration. These products are not intended to diagnose, treat, cure or prevent any diseases or medical conditions. Results are based on the Buyer Reviews Ranking System and do not necessarily reflect typical results from the use of these products. Please visit product websites for more information.<br>
	      </p>
		</div>	
</footer>
